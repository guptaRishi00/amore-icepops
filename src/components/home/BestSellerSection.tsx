...
export default function BestSellerSection() {
  return (
    ...
    <section className="relative w-full bg-[#406BB5] py-10 md:py-24 px-4 md:px-8 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 lg:gap-8 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute bottom-4 -right-1 md:bottom-8 md:-right-16 bg-stone-900 text-white px-5 py-3 rounded-2xl border-2 border-white shadow-xl z-20 flex items-center gap-3 hover:rotate-0 transition-transform duration-300 cursor-default"
          >
